...
const ClientMetricsCards = ({ metrics }) => {
  const cards = [
    {
      ...
      bgColor: 'bg-blue-50',
      description: 'Across all cloud providers'
    },
    {
      title: 'Active Users',
      ...
      bgColor: 'bg-green-50',
      description: 'Five-tier hierarchy'
    },
    {
      title: 'Cognito Sessions',
      value: metrics?.cognitoSessions,
      color: 'bg-purple-500',
      textColor: 'text-purple-600',
      bgColor: 'bg-purple-50',
      description: 'Active authentications'
    },
    {
