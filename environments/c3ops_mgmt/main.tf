...
module "c3finops_dev" {
  ...
  c3finops_web_ami       = "t2.micro"
  c3finops_app_ami       = "t2.micro"
  ...
  rds_instance_class      = "db.c6gd.medium"
  rds_subnet_group        = data.terraform_remote_state.c3ops_preprod_core_infra.outputs.db_subnet_group
  rds_admin_sg            = data.terraform_remote_state.c3ops_preprod_core_infra.outputs.admin-sg.mysql_sg_id
